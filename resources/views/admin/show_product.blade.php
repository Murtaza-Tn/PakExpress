                ...
                @forelse ($product as $product)
                    ...
                    <tr>
                        ...
                        <td>
                            ...
                            color: #fff;"
                                class="btn btn-info" href="{{ url('detials', $product->id) }}">View</a>
                        </td>
                        ...
                        <td>
                            ...
                            background-color: #088178;
                            color: #fff;"
                                onclick="return confirm('Are You Sure To Delete This')" class="btn btn-danger"
                                href="{{ url('delete_productss', $product->id) }}">Delete</a>
                        </td>
                        <td>
                            <a style="border-radius: 3px;
                            background-color: #088178;
                            color: #fff;"
                                class="btn btn-success" href="{{ url('update_product', $product->id) }}">Edit</a>
                        </td>
                    </tr>
                @empty
